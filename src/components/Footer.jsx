...
export const Footer = () => {
    return (
        <>
        <footer className="fixed bottom-0 inset-x-0 container mx-auto px-10 md:px-0">
            <div className="mx-16 mb-16 flex flex-col md:flex-row md:items-center justify-between">
                <div>
                    <svg
                ...
                <div className="grow mt-4 md:mt-0 md:ml-12">
                    ...
                    © 2023 EduTech Company
                    </p>
                </div>
                <div className="flex space-x-6 mt-4 md:mt-0 text-[rgb(196,130,252,0.8)]">
                    <span>
                    <svg
                        width="24"
                        height="25"
